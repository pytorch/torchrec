        ...
        while True:
            ...
            if child_node.op == "placeholder":
                ...
                if fn_module == "builtins" and fn_name == "getattr":
                    ...
                    # pyre-fixme[16]
                    arg = child_node.args[0][arg_info.step[0].input_attr]
                elif (
                    fn_module == "torchrec.sparse.jagged_tensor"
                    and fn_name == "KeyedJaggedTensor"
                ):
