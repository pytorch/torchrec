...
class TestEmbeddingPerfEstimator(unittest.TestCase):
    ...
    def test_1_table_perf(self) -> None:
        ...
        expected_perfs = {
            ...
            ("dense", "table_column_wise"): [3543.7999681477945],
            ("batched_dense", "table_column_wise"): [3504.659977703456],
            ("batched_fused", "table_column_wise"): [3458.9966555183946],
            ("sparse", "table_column_wise"): [3543.7999681477945],
            ("batched_fused_uvm", "table_column_wise"): [83727.05882352941],
            ("batched_fused_uvm_caching", "table_column_wise"): [22014.604904632153],
        }
