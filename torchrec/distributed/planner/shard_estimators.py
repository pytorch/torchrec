    ...
    def estimate(
        ...
        for sharding_option in sharding_options:
            ...
            shard_perfs = perf_func_emb_wall_time(
                ...
                bw_hbm_mem=self._topology.hbm_mem_bw,
                bw_ddr_mem=self._topology.ddr_mem_bw,
...
def perf_func_emb_wall_time(
    ...
    Args:
        ...
        bw_hbm_mem(float): the bandwith of GPU HBM.
        bw_ddr_mem(float): the bandwith of system DDR memory.
    ...
    device_bw = kernel_bw_lookup(
        compute_device, compute_kernel, bw_hbm_mem, bw_ddr_mem, caching_ratio
    )
