...
# @manual
from torch.distributed._shard.sharded_tensor import Shard  # noqa

# @manual
from torch.distributed._shard.sharding_spec import ShardingSpec  # noqa
