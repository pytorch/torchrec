...
class KJTFeaturesIndicesAwaitable(Awaitable[KeyedJaggedTensor]):
    """
    ...
    def _wait_impl(self) -> KeyedJaggedTensor:
        ...
        return self._id_list_features_awaitable.wait()


class KJTLengthsAwaitable(Awaitable[KJTFeaturesIndicesAwaitable]):
    """
    Awaitable of KJT indices distribution.
    ...
    def _wait_impl(self) -> KJTFeaturesIndicesAwaitable:
        """
        ...
        """
        return KJTFeaturesIndicesAwaitable(
