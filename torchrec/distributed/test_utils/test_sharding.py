...
def _verify_and_gather_predictions_for_single_run(
...
def sharding_single_rank_test_single_process(
    ...
    first_run = _verify_and_gather_predictions_for_single_run(
        pg=pg,
        device=device,
        rank=rank,
        world_size=world_size,
    ...
    if random_seed is not None:
        second_run = _verify_and_gather_predictions_for_single_run(
            pg=pg,
            device=device,
            rank=rank,
            world_size=world_size,
        ...
        torch.testing.assert_close(first_run, second_run)
