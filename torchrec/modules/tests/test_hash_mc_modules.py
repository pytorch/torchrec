...
class TestMCH(unittest.TestCase):
    ...
    def test_zch_hash_inference(self) -> None:
        ...
        self.assertEqual(m1._hash_zch_identities.dtype, torch.int32)
        in1 = {
            "f": JaggedTensor(
    ...
    def test_zch_hash_train_rescales_four(self, hash_size: int) -> None:
        ...
        in1, in2, in3, in4 = bucketized_kjt.split([len(kjt.keys())] * world_size)
        ...
        o1_1 = m1_1(in1.to_dict())
        o2_1 = m2_1(in2.to_dict())
        o3_1 = m3_1(in3.to_dict())
        o4_1 = m4_1(in4.to_dict())
        ...
        if hash_size > 0:
            ...
            # simulate kjt call
            bucketized_kjt2, permute2 = bucketize_kjt_before_all2all(
                kjt2,
                num_buckets=world_size,
                block_sizes=block_sizes,
                keep_original_indices=keep_original_indices,
            ...
            in1_2, in2_2 = bucketized_kjt2.split([len(kjt2.keys())] * world_size)
        else:
            bucketized_kjt2, permute2 = bucketize_kjt_before_all2all(
                kjt2,
                num_buckets=world_size,
            ...
            kjts = bucketized_kjt2.split([len(kjt2.keys())] * world_size)
            # rebuild kjt
        ...
        self.assertTrue(
            torch.allclose(
                ...
                torch.index_select(
                    ...
                    dim=0,
                    index=cast(torch.Tensor, permute2),
                ),
            )
        )
