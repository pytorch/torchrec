...
def to_fbgemm_bounds_check_mode(
    ...
    if bounds_check_mode == BoundsCheckMode.FATAL.value:
        return FbgemmBoundsCheckMode.FATAL
    elif bounds_check_mode == BoundsCheckMode.WARNING.value:
        return FbgemmBoundsCheckMode.WARNING
    elif bounds_check_mode == BoundsCheckMode.IGNORE.value:
        return FbgemmBoundsCheckMode.IGNORE
    elif bounds_check_mode == BoundsCheckMode.NONE.value:
...
def to_fbgemm_cache_algorithm(cache_algorithm: CacheAlgorithm) -> FbgemmCacheAlgorithm:
    if cache_algorithm == CacheAlgorithm.LRU.value:
        return FbgemmCacheAlgorithm.LRU
    elif cache_algorithm == CacheAlgorithm.LFU.value:
