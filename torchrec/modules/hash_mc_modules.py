...
class HashZchManagedCollisionModule(ManagedCollisionModule):
    ...
    Args:
        ...
        expire_hr (to be deprecated - do not use): the duration in hour for an ID to stay unexpired if eviction is enabled
        ...
        identity_long_type: use long type to store ID's identity, recommend to set to True
        _modulo_identity_DPRECATED (already deprecated): the flag for backward compatibility
        name: the name of the embedding table
    ...
    def __init__(
        ...
        identity_long_type: bool = False,
        _modulo_identity_DPRECATED: bool = False,
        name: Optional[str] = None,
        ...
        self._modulo_identity_DPRECATED: bool = _modulo_identity_DPRECATED
        ...
        self._identity_long_type: bool = identity_long_type
        self._name: Optional[str] = name

        self._expire_hr: int = -1 if is_inference else expire_hr
        ...
        self._eviction_module: Optional[HashZchEvictionModule] = (
            HashZchEvictionModule(self._eviction_policy_name, self._eviction_config)
        ...
        identities, metadata = torch.ops.torchrec.create_zch_buffer(
            size=self._zch_size,
            support_evict=self._expire_hr > 0 or self._eviction_module is not None,
            device=self._device,
            long_type=self._identity_long_type,
        )
        ...
        logger.info(
            ...
            f"{self._expire_hr=}, {self._is_inference=}, {self._identity_long_type=}, "
            f"{self._modulo_identity_DPRECATED=}, {self._tb_logging_frequency=}, "
    ...
    def remap(self, features: Dict[str, JaggedTensor]) -> Dict[str, JaggedTensor]:
        metadata: Optional[torch.Tensor] = self._hash_zch_metadata
        exp_hours = self._expire_hr
        readonly: bool = False
        ...
        with torch.no_grad():
            ...
            for name, feature in features.items():
                ...
                remapped_ids, evictions = torch.ops.torchrec.zero_collision_hash(
                    input=values,
                    ...
                    _modulo_identity_DPRECATED=self._modulo_identity_DPRECATED,
    ...
    def rebuild_with_output_id_range(
        ...
        return self.__class__(
            ...
            identity_long_type=self._identity_long_type,
            _modulo_identity_DPRECATED=self._modulo_identity_DPRECATED,
            name=self._name,
